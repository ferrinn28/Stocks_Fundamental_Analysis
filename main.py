...
if __name__ == "__main__":
    ...
    print(f"Cumulative Revenue {ticker_code} Q1 :", searching_data.calculate_cumulative_revenue())
    print(f"Cumulative Net Income {ticker_code} Q1 :", searching_data.calculate_cumulative_net_income())